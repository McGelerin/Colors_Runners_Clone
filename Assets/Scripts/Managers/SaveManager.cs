    ...
    public class SaveManager : MonoBehaviour
    {
        ...
        private void OnIdleSaveData()
        {
            IdleSaveGame(new SaveIdleDataParams()
            {
                ...
                MainSideCurrentScore = SaveSignals.Instance.onSaveIdleParams().MainSideCurrentScore,
        ...
        private void IdleSaveGame(SaveIdleDataParams saveIdleDataParams)
        {
            ...
            if (saveIdleDataParams.MainSideCurrentScore != null) ES3.Save("MainSideCurrentScore", saveIdleDataParams.MainSideCurrentScore,"IdleGame.es3");
        ...
        private void OnIdleGameLoad(SaveIdleDataParams saveIdleDataParams)
        {
            SaveSignals.Instance.onLoadIdleGame?.Invoke(new SaveIdleDataParams()
                {
                    ...
                    MainSideCurrentScore = ES3.KeyExists("MainSideCurrentScore","Idlegame.es3")? ES3.Load<List<int>>("MainSideCurrentScore","IdleGame.es3"):default,
